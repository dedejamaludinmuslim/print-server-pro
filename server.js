...
const ALLOWED_ORIGINS = ['https://printer-upmp.vercel.app', 'null'];
...
app.get('/ping', (req, res) => res.json({ status: 'PrintServerActive', hostname: os.hostname(), localIps: getLocalIps() }));
app.get('/connection-info', (req, res) => res.json({ hostname: os.hostname(), localIps: getLocalIps(), port }));
