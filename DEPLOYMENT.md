...
git commit -m "Deploy Print Server Pro v4.6.5 with GitHub Pages"
...
## 3. Perbarui Release stabil v4.6.5

1. Buka halaman repository, lalu pilih **Releases**.
2. Buka Release `v4.6.5`. Jika belum ada, buat tag `v4.6.5` dari branch
   `main`.
...
Isi manifest terbaru harus menunjukkan versi `4.6.5`.
...
Server harus melaporkan versi `4.6.5`, task tetap berjalan setelah terminal
