...
git commit -m "Deploy Print Server Pro v4.6.9 professional header"
...
## 3. Perbarui Release stabil v4.6.9

1. Buka halaman repository, lalu pilih **Releases**.
2. Buka Release `v4.6.9`. Jika belum ada, buat tag `v4.6.9` dari branch
   `main`.
...
Isi manifest terbaru harus menunjukkan versi `4.6.9`.
...
Server harus melaporkan versi `4.6.9`, task tetap berjalan setelah terminal
